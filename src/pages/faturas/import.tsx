...
import { Box, Flex, Heading, Divider, Text, Button, Icon, FormControl, FormLabel, VStack} from '@chakra-ui/react';
      ...
      <Header />
       <Flex w='100%'  my='6' maxWidth={1840} mx='auto' px='6'>
        ...
        <Box flex='1' borderEndRadius={8} bg='white' p='8'>
          ...
          <Box color='gray.500' w='80%' m='auto' bg="gray.100" borderRadius="8" p='2' mb='10'>
            <VStack spacing='2' alignItems='flex-start'>
              ...
              <Text>
                Loja_Sigla, Numero da Fatura, Valor da Nota(EM CENTAVOS), Valor dos seviços(EM CENTAVOS), Data de Vencimento, Data da emição
              </Text>
              <Text fontWeight='bold'>Exemplo:</Text>
            
              <Box bg='white' borderRadius="8" p='2' fontWeight='bold' color='gray.300' w="100%" borderColor='yellow.400' borderWidth={2}>
