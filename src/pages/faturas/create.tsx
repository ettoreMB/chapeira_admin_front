...
export default function CreateInvoice() {
  ...
  const handleCreateInvoice: SubmitHandler<CreateInvoiceFormData> = async (
    data
  ) => {
    const invoice = {
      ...data,
